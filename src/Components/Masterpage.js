...
export default function MatserPage() {
  ...
  function HandlegetData(event) {
    ...
    fetch("http://192.168.0.122:5000/getDbDataApi", {
      method: "GET",
    })
  ...
  const handleClickSave = (event) => {
    ...
    fetch("http://192.168.0.122:5000/taskSaveApi", {
      method: "POST",
      headers: {
  ...
  const handleClickUpdate = (event) => {
    ...
    fetch("http://192.168.0.122:5000/updateMasterUser", {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleSearch = () => {
    ...
    fetch("http://192.168.0.122:5000/searchuser", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleDelete = (name) => () => {
    ...
    fetch("http://192.168.0.122:5000/deleteUser", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
